...
_SE_FINANCE_KEYWORDS = [
    ...
    "black scholes", "greeks", "implied volatility", "options pricing",
    "etf", "mutual fund", "hedge fund", "private equity",
    "p/e ratio", "ebitda", "wacc", "capm", "irr", "npv", "roi",
    "backtesting", "momentum", "mean reversion", "pairs trading",
    "factor model", "risk parity", "kelly criterion", "position sizing",
    "candlestick", "bollinger", "rsi", "macd", "fibonacci",
    "inflation", "gdp", "monetary policy", "central bank", "federal reserve",
    "mortgage", "loan", "amortization", "annuity", "insurance",
    "cryptocurrency", "blockchain", "bitcoin", "ethereum",
    "ipo", "merger", "acquisition", "earnings per share",
    # --- Data science & ML ---
    ...
    "pca", "dimensionality reduction", "feature selection", "feature importance",
    ...
    "convolutional", "lstm", "transformer", "attention",
    "huggingface", "openai", "langchain", "vector database",
    # --- Statistics & math ---
    ...
    "t-test", "anova", "chi-square", "p-value", "confidence interval",
    "normal distribution", "poisson", "binomial", "log-normal",
    "central limit theorem", "law of large numbers",
    "ols", "logistic regression", "lasso", "ridge", "elastic net",
    "fourier", "wavelet", "autocorrelation", "stationarity",
    ...
    "spark", "hadoop", "kafka", "airflow", "dbt", "pipeline",
    "aws", "gcp", "azure", "s3", "bigquery", "snowflake",
    "jupyter", "notebook", "streamlit", "flask", "fastapi", "dash",
    "docker", "kubernetes", "ci/cd", "unit test", "pytest",
    "argparse", "logging", "decorator", "generator", "iterator",
    "list comprehension", "dictionary", "lambda", "map", "filter",
    "recursion", "dynamic programming", "sorting", "graph", "tree",
    "file handling", "xml", "yaml", "environment variable",
    # --- General Python patterns that produce code answers ---
    "implement", "calculate", "compute", "visualize", "automate",
    "parse", "serialize", "deserialize", "encrypt", "compress",
    "schedule", "cron", "batch", "stream", "real-time",
]
